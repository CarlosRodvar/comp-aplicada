...
print(f'Carta:        {copias_carta}   --   ${total_carta:.2f}')
print(f'Oficio:       {copias_oficio}   --   ${total_oficio:.2f}')
print(f'Doble oficio: {copias_dobleoficio}   --   ${total_dobleoficio:.2f}')
print(f'Plano:        {copias_plano}   --   ${total_plano:.2f}')
print('--------------------------------------')
